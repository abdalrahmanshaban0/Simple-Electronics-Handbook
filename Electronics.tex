...
\begin{align*}
    ...
    V_o &= -\frac{R_2}{R_1}V_1 + \frac{R_4}{R_3 + R_4} \left(\frac{R_2}{R_1}+1\right)V_2 \\
    \text{When } R_1 &= R_3 \text{, } R_2 = R_4 \\
    V_o &= -\frac{R_2}{R_1}V_1 + \frac{R_2}{R_1 + R_2} \left(\frac{R_2}{R_1}+1\right)V_2 \\    
    V_o &= -\frac{R_2}{R_1}V_1 + \frac{R_2}{R_1 + R_2} \left(\frac{R_1+R_2}{R_1}\right)V_2 \\    
